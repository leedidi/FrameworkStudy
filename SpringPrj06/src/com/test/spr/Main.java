...
public class Main
{
	public static void main(String[] args)
	{
		...
		*/
		...
		//@ newProxyInstance 는 걍 007 가방! 설정값 넘겨준다고 생각하면 됨
		Calculator proxy = (Calculator)Proxy.newProxyInstance(
				           cal.getClass().getClassLoader()   // 주 업무 실행 클래스에 대한 정보 전달(제공)   //@ A의 얼굴, 체취 등
					       , cal.getClass().getInterfaces()  // 주 업무 실행 클래스의 인터페이스에 대한 정보 //@ A의 부모 대한 정보
